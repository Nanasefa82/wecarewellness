-- Fix the create_recurring_availability function to not use jsonb_path_exists
-- Replace jsonb_path_exists with a compatible alternative
      ...
      IF day_exists THEN
        ...
        BEGIN
          INSERT INTO availability_slots (
            ...
            slot_start_time,
            slot_end_time,
            COALESCE(time_slot->>'type', 'consultation')
          );
